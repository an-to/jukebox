...
router.post('/playlist/:id/add', (req, res) => {
  db.addTrack(req.body.song, req.app.get('connection'))
    .then((trackId) => {
      return db.addToPlaylist(trackId, req.params.id, req.app.get('connection'))
    })
    .then(() => {
      res.sendStatus(201)
    })
